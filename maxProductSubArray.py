def maxProdSubarray(nums):
    ...
    for i in range(1, len(nums)):
        ...
        ans = max(currMaxProduct, currMinProduct)
...
"""
Array:        [1, 2,                   -3,                     0,  .................]
    currMax    1  max(1*2, 1*2, 2)=2   max(2*-3, 2*-3, -3)=-6  max(-6*0, -6*0, 0)=0
    currMin    1  min(1*2, 1*2, 2)=2   min(x*-3, 2*-3, -3)=-6  min(-6*0, -6*0, 0)=0
    ans        1  max(2,2)=2           max(-6,-6)=-6           max(0,0)=0
    prevMax    1  2                    -6                      0
    prevMin    1  2                    -6                      0
